...
UUID=${UUID:-'5e9b9889-bdcf-4846-90c7-6e1ccfb50c6c'}
VMESS_WSPATH=${VMESS_WSPATH:-'/5e9b9889-bdcf-4846-90c7-6e1ccfb50c6c-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/5e9b9889-bdcf-4846-90c7-6e1ccfb50c6c'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/5e9b9889-bdcf-4846-90c7-6e1ccfb50c6c-trojan'}
SS_WSPATH=${SS_WSPATH:-'/5e9b9889-bdcf-4846-90c7-6e1ccfb50c6c-shadowsocks'}
